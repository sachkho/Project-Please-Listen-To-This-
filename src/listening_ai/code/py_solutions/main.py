...
def launchListeningMachine(stream_mode, audio_data = None):
    ...
    if stream_mode : 
        input_device_id = 0  # Vous pouvez ajuster l'index de l'appareil d'entrée ici 
...
if __name__ == "__main__":
    launchListeningMachine(stream_mode=False, audio_data = "src/listening_ai/resources/conversation.wav")